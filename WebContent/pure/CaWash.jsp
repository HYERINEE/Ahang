...
<body>
	...
	ArrayList<Total_modelVO> list = dao.CaWash();
		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="pricing-card pricing-primary"
						...
						<div class="oil_rank1" href="./AhangHome.html" title="">
							<a href="AhangProduct.html"> <img
								src="./assets/prod/img_oil/oil_0.jpg" class="oil_rank1-img"
								alt="" style="height: 300px; width: 250px;">
							</a>
						</div>
						<span
				...
				<div class="col-md-4">
					<div class="pricing-card pricing-primary"
						...
						<div class="oil_rank1" href="./AhangHome.html" title="">
							<a href="AhangProduct.html"> <img
								src="./assets/prod/img_oil/oil_1.jpg" class="oil_rank1-img"
								alt="" style="height: 300px; width: 250px;">
							</a>
						</div>
						<span
							style="margin: 0px 0px 5px; font-family: sans-serif; font-size: 17px; color: rgb(143, 143, 143);">
							궁중비책(GOONGBE)</span><br> <span style="font-size: 17px;">수딩 젤</span>
						</h6>
						<div class="rank1_bar bar1"
							style="margin: 0px auto; width: 234.6px; height: 3px; border-top: 0.5px solid rgb(141, 158, 186);"></div>
						<div class="star">
				...
				<div class="col-md-4">
					<div class="pricing-card pricing-primary"
						...
						<div class="lotion_rank1" href="./AhangHome.html" title="">
							<a href="AhangProduct.html"> <img
								src="./assets/prod/img_oil/oil_2.jpg" class="oil_rank1-img"
								alt="" style="height: 300px; width: 250px;">
							</a>
						</div>
						<span
							style="margin: 0px 0px 5px; font-family: sans-serif; font-size: 17px; color: rgb(143, 143, 143);">
							프로맘(fromom)</span><br> <span style="font-size: 17px;">초단백 크림
							베이비</span>
						</h6>
						<div class="rank1_bar bar1"
							style="margin: 0px auto; width: 234.6px; height: 3px; border-top: 0.5px solid rgb(141, 158, 186);"></div>
				...
				<div class="col-md-4">
					<div class="pricing-card pricing-primary"
						...
						<div class="lotion_rank1" href="./AhangHome.html" title="">
							<a href="AhangProduct.html"> <img
								src="./assets/images/shampoo.jpg" class="lotion_rank1-img"
								alt="" style="height: 300px; width: 250px;">
							</a>
						</div>
						<span
							style="margin: 0px 0px 5px; font-family: sans-serif; font-size: 17px; color: rgb(143, 143, 143);">
							궁중비책(GOONGBE)</span><br> <span style="font-size: 17px;">샴푸&바스</span>
						</h6>
						<div class="rank1_bar bar1"
							style="margin: 0px auto; width: 234.6px; height: 3px; border-top: 0.5px solid rgb(141, 158, 186);"></div>
						<div class="star">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="pricing-card pricing-primary"
						style="padding: 0px; background-color: white; height: 400px; width: 250;">
						<div class="lotion_rank1" href="./AhangHome.html" title="">
							<a href="AhangProduct.html"> <img src="./assets/images/i.jpg"
				...
				<div class="col-md-4">
					<div class="pricing-card pricing-primary"
						...
						<div class="lotion_rank1" href="./AhangHome.html" title="">
							<a href="AhangProduct.html"> <img
								src="./assets/images/soothing.jpg" class="lotion_rank1-img"
								alt="" style="height: 300px; width: 250px;">
							</a>
						</div>
						<span
				...
				<div class="col-md-4">
					<div class="pricing-card pricing-primary"
						...
						<div class="lotion_rank1" href="./AhangHome.html" title="">
							<a href="AhangProduct.html"> <img
								src="./assets/images/jell.jpg" class="lotion_rank1-img" alt=""
								style="height: 300px; width: 250px;">
							</a>
						</div>
						<span
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="pricing-card pricing-primary"
						style="padding: 0px; background-color: white; height: 400px; width: 250;">
						<div class="lotion_rank11" href="./AhangHome.html" title="">
							<img src="./assets/images/jell.jpg" class="lotion_rank11-img"
								alt="" style="height: 300px; width: 250px;">
